namespace Finix.Code
{
    public class OperatorProvider
    {
        ...
        private string LoginUserKey = "Finix_loginuserkey_2019";
        ...
        public void AddCurrent(OperatorModel operatorModel)
        {
            ...
            WebHelper.WriteCookie("Finix_mac", Md5.md5(Net.GetMacByNetworkInterface().ToJson(), 32));
            WebHelper.WriteCookie("Finix_licence", Licence.GetLicence());
        }
